...
&=&
\frac{1}{2} Tr \bigg [ K^{-1} \frac{\partial K}{\partial \theta_t} \bigg (K^{-1} M_{YY} - I_N \bigg ) \bigg ]
 \label{eq:L_grad}
\end{eqnarray}
...
\bigg \rangle
= \bigg \langle
\begin{bmatrix} X^1 \\ \hline Y^1 \end{bmatrix}
\hdots
\begin{bmatrix} X^N \\ \hline Y^N \end{bmatrix}
 \bigg \rangle 
\end{eqnarray}
...
\begin{bmatrix} y^1_i & \hdots & y^N_i \end{bmatrix}
\bigg ) = \begin{bmatrix}
<Y^1, Y^1> & \hdots  & <Y^1, Y^N> \\ 
\vdots & \ddots & \vdots \\ 
<Y^N, Y^1> & \hdots & <Y^N, Y^N>
\end{bmatrix}
\end{eqnarray}
...
\begin{eqnarray}
\frac{1}{2} Tr \bigg [ K^{-1} \frac{\partial K}{\partial \theta_t} \bigg (K^{-1} M^o_{YY} - o I_N \bigg ) \bigg ]
\end{eqnarray}
